  ...
  en: {
    ...
    surveyDataReport: {
      ...
      courtenay: {
        lastUpdated: "Last updated: 10-15-2025",
        keyInsightsLabel: "Key Insights:",
        keyInsights: "White respondents make up the largest group of survey respondents at 57.29%, followed by Chinese (10.42%) and South Asian (5.21%).",
        ethnicities: [
  ...
  fr: {
    ...
    surveyDataReport: {
      ...
      courtenay: {
        lastUpdated: "Dernière mise à jour: 15-10-2025",
        keyInsightsLabel: "Aperçus Clés:",
        keyInsights: "Les répondants blancs constituent le plus grand groupe de répondants au sondage à 57,29%, suivis par les Chinois (10,42%) et les Sud-Asiatiques (5,21%).",
        ethnicities: [
