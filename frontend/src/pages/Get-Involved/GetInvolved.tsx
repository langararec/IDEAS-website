                ...
                <div className="space-y-4 w-full lg:w-1/3">
                    <form onSubmit={handleSubmit} className="space-y-4 w-full">
                        ...
                        <button 
                            ...
                            className="bg-accent hover:cursor-pointer hover:bg-accent/80 duration-300 text-white font-medium py-2 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wide"
                        >
